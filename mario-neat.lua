...
function displayGenome(genome)
	...
	for n,cell in pairs(cells) do
		if n > Inputs or cell.value ~= 0 then
			...
			forms.drawBox(netPicture,cell.x-2,cell.y-2,cell.x+2,cell.y+2,0xFF000000,color)
...
while true do
	...
	if timeout + timeoutBonus <= 0 then
		...
		local file = io.open("C:/Users/jobol/Downloads/BizHawk-2.2.2/Lua/SNES/neat-mario/log/log.txt", "a")
        file:write(pool.generation .. "," .. pool.currentSpecies .. "," .. pool.currentGenome .. "," .. fitness .. "\n")
		file:close()
		pool.currentSpecies = 1
		pool.currentGenome = 1
		while fitnessAlreadyMeasured() do
